...
export const FaqDescription = ({ children }) => <p className='mt-4 text-lg text-gray-500'>{children}</p>

export const FaqContent = ({ children }) => <dl className='space-y-12'>{children}</dl>
